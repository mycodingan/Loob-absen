                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td contenteditable="true">{{ $data->No_absen }}</td>
                                        <td contenteditable="true">{{ $data->Nama_Karyawan }}</td>
                                        <td contenteditable="true">{{ $data->cabang }}</td>
                                        <td contenteditable="true">{{ $data->posisi_jabatan }}</td>
                                        @php
                                            $total_shift_1 = null;
                                            $total_shift_2 = null;
                                            $total_shift_ls = null;
                                        ...
                                        @endfor
                                        <td contenteditable="true">{{ $total_shift_1 }}</td>
                                        <td contenteditable="true">{{ $total_shift_2 }}</td>
                                        <td contenteditable="true">{{ $total_shift_ls }}</td>
                                        <td contenteditable="true" id="total_shift_1_jt">{{ $total_shift_1 * 7 }}</td>
                                        <td contenteditable="true" id="total_shift_2_jt">{{ $total_shift_2 * 7 }}</td>
                                        <td contenteditable="true" id=" total_shift_ls">{{ $total_shift_ls * 8 }}</td>
                                        <td contenteditable="true" id="total_jt">{{ ($total_shift_1 * 7) + ($total_shift_2 * 7) + ($total_shift_ls * 8) }}</td>
                                        <td contenteditable="true">{{ $data->tahun }}</td>
                                        <td contenteditable="true">{{ $data->Bulan }}</td>
                                        <td>
